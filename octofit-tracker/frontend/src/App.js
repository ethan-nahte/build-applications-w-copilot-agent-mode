    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-primary mb-4 shadow-sm">
      <div className="container-fluid">
        <Link className="navbar-brand d-flex align-items-center" to="/">
          <img src="/octofitapp-small.svg" alt="Octofit Logo" style={{height: '36px', marginRight: '12px'}} />
          <span style={{color: '#fff', fontWeight: 'bold', fontSize: '1.6rem', letterSpacing: '1px'}}>Octofit Tracker</span>
        </Link>
